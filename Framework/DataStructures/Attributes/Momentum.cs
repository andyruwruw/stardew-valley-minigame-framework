...
namespace MinigameFramework.DataStructures.Attributes
{
    ...
    internal class Momentum
    {
        ...
        /// <summary>
        /// Maximum velocity <see cref="Momentum"/> can travel.
        /// </summary>
        ...
        /// <summary>
        /// Position of <see cref="Momentum"/> as <see cref="Vector2"/>.
        /// </summary>
        private Vector2 _position;

        /// <summary>
        /// Mass of the <see cref="Momentum"/>.
        /// </summary>
        private float _mass;

        /// <summary>
        /// Instantiates a <see cref="Momentum"/>.
        /// </summary>
        ...
        /// <summary>
        /// <para>Instantiates a <see cref="Momentum"/>.</para>
        ...
        /// <summary>
        /// Adds a <see cref="Vector2"/> to the acceleration of the <see cref="Momentum"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds a <see cref="Vector2"/> to the position of the <see cref="Momentum"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds a <see cref="Vector2"/> to the velocity of the <see cref="Momentum"/>.
        /// </summary>
        ...
        /// <summary>
        /// Divides a <see cref="Vector2"/> from the acceleration of the <see cref="Momentum"/>.
        /// </summary>
        ...
        {
            this._acceleration = Vector2.Divide(
                this._acceleration,
                acceleration
            );
        }
        ...
        /// <summary>
        /// Divides a float from the acceleration of the <see cref="Momentum"/>.
        /// </summary>
        ...
        /// <summary>
        /// Divides a float from the position of the <see cref="Momentum"/>.
        /// </summary>
        ...
        /// <summary>
        /// Divides a float from the velocity of the <see cref="Momentum"/>.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves acceleration of <see cref="Momentum"/> as <see cref="Vector2"/>.
        /// </summary>
        /// <returns>Acce;eratopm of <see cref="Momentum"/> as <see cref="Vector2"/></returns>
        ...
        /// <summary>
        /// Retrieves mass of the <see cref="Momentum"/>.
        /// </summary>
        /// <returns>Mass of the <see cref="Momentum"/></returns>
        ...
        /// <summary>
        /// Retrieves maximum acceleration <see cref="Momentum"/> can speed up.
        /// </summary>
        /// <returns>Maximum acceleration <see cref="Momentum"/> can speed up</returns>
        ...
        /// <summary>
        /// Retrieves maximum velocity <see cref="Momentum"/> can travel.
        /// </summary>
        /// <returns>Maximum velocity <see cref="Momentum"/> can travel</returns>
        ...
        /// <summary>
        /// Retrieves position of <see cref="Momentum"/> as <see cref="Vector2"/>.
        /// </summary>
        /// <returns>Position of <see cref="Momentum"/> as <see cref="Vector2"/></returns>
        ...
        /// <summary>
        /// Retrieves velocity of <see cref="Momentum"/> as <see cref="Vector2"/>.
        /// </summary>
        /// <returns>Velocity of <see cref="Momentum"/> as <see cref="Vector2"/></returns>
        ...
        /// <summary>
        /// Multiplies a <see cref="Vector2"/> with the acceleration of the <see cref="Momentum"/>.
        /// </summary>
        ...
        {
            this._acceleration = Vector2.Multiply(
                this._acceleration,
                acceleration
            );
        }
        ...
        /// <summary>
        /// Multiplies a float with the acceleration of the <see cref="Momentum"/>.
        /// </summary>
        ...
        /// <summary>
        /// Multiplies a float with the position of the <see cref="Momentum"/>.
        /// </summary>
        ...
        /// <summary>
        /// Multiplies a float with the velocity of the <see cref="Momentum"/>.
        /// </summary>
        ...
        /// <summary>
        /// Sets acceleration of <see cref="Momentum"/> as <see cref="Vector2"/>.
        /// </summary>
        /// <param name="acceleration">New acceleration of <see cref="Momentum"/> as <see cref="Vector2"/></param>
        ...
        /// <summary>
        /// Sets mass of the <see cref="Momentum"/>.
        /// </summary>
        /// <param name="mass">New mass of the <see cref="Momentum"/></param>
        ...
        /// <summary>
        /// Sets maximum acceleration <see cref="Momentum"/> can speed up.
        /// </summary>
        /// <param name="maximumAcceleration">New maximum acceleration <see cref="Momentum"/> can speed up</param>
        ...
        /// <summary>
        /// Sets maximum velocity <see cref="Momentum"/> can travel.
        /// </summary>
        /// <returns>New maximum velocity <see cref="Momentum"/> can travel</returns>
        ...
        /// <summary>
        /// Sets position of <see cref="Momentum"/> as <see cref="Vector2"/>.
        /// </summary>
        /// <param name="position">New position of <see cref="Momentum"/> as <see cref="Vector2"/></param>
        ...
        /// <summary>
        /// Sets velocity of <see cref="Momentum"/> as <see cref="Vector2"/>.
        /// </summary>
        /// <param name="velocity">New velocity of <see cref="Momentum"/> as <see cref="Vector2"/></param>
        ...
        /// <summary>
        /// Subtracts a <see cref="Vector2"/> from the acceleration of the <see cref="Momentum"/>.
        /// </summary>
        ...
        {
            this._acceleration = Vector2.Subtract(
                this._acceleration,
                acceleration
            );
        }
        ...
        /// <summary>
        /// Subtracts a <see cref="Vector2"/> from the position of the <see cref="Momentum"/>.
        /// </summary>
        ...
        /// <summary>
        /// Updates position, velocity and acceleration of <see cref="Momentum"/>.
        /// </summary>
        public void Update()
        {
            this._position = Vector2.Add(
